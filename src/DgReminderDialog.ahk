...
;==============================================================================
OnReminderDlg_RadPeriodicClick(CtrlHwnd, GuiEvent, EventInfo, ErrLevel := "")
{
    _Logger.BEGIN(A_ThisFunc)

    GuiControl, Enable,     % _App.ui.dlgReminder.hEditPeriodMin

    GuiControl, Enable,     % _App.ui.dlgReminder.hEditDurationHour
    GuiControl, Enable,     % _App.ui.dlgReminder.hEditDurationMin

    _Logger.END( A_ThisFunc)
}
;==============================================================================
OnReminderDlg_RadHourlyClick(CtrlHwnd, GuiEvent, EventInfo, ErrLevel := "")
{
    _Logger.BEGIN(A_ThisFunc)

    GuiControl, Disable, % _App.ui.dlgReminder.hEditPeriodMin

    GuiControl, Disable, % _App.ui.dlgReminder.hEditDurationHour
    GuiControl, Disable, % _App.ui.dlgReminder.hEditDurationMin

    _Logger.END( A_ThisFunc)
}
;==============================================================================
OnReminderDlg_BtnStartClick(CtrlHwnd, GuiEvent, EventInfo, ErrLevel := "")
{
    _Logger.BEGIN(  A_ThisFunc )

    state := _App.ui.dlgReminder.submit()
    task  := _App.taskMan.getTaskByName( state.name )
   ...
   ; _Logger.TRACE(A_ThisFunc,"taskName", name, "task",  task)
    ...
    _App.ui.dlgReminder.saveState()
    _App.ui.dlgReminder.hide()

    ;_Logger.TRACE( A_ThisFunc, "task", task )
    _Logger.END(  A_ThisFunc )
}
;==============================================================================
OnReminderDlg_BtnCancelClick(CtrlHwnd, GuiEvent, EventInfo, ErrLevel := "")
{
    _Logger.BEGIN(  A_ThisFunc )
